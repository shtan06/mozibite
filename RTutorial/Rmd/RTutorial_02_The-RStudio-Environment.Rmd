...
[__>>__ Session Three](RTutorial_03_Coding-Arithmetic-Operators.html)
...
We have seen from Session 1 (Introduction to R) the main purpose of using R, that is to capture, clean, analyse and present data. There are thousands of packages to choose from and here are some popular and useful ones. The below names in red are packages we will be installing in this tutorial.  

__Data Loading__  
DBI, odbc, RMySQL, RPostgresSQL, RSQLite, XLConnect, xlsx, <span style="color: red;">readxl</span>  

__Manipulate Data__  
<span style="color: red;">dplyr</span>, tidyr, stringr, lubridate, magrittr, <span style="color: red;">reshape2</span>   

__Visualise Data__  
<span style="color: red;">ggplot2, plotly</span>, ggvis, rgl, essquise, <span style="color: red;">htmlwidgets</span>, leaflet, dygraphs, <span style="color: red;">DT, kable/kableExtra, formattable</span>, diagrammeR, network3D, threeJS, goggleVis, DataExplorer  

__Spatial Data__  
sp, maptools, maps, ggmap  

__Publishing__  
<span style="color: red;">RMarkdown, Flexdashboard, Shiny</span>, Radiant  
