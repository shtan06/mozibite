...
Executing commands from your Terminal or Command Prompt is almost unavoidable in Python. Beginners may find it difficult to make sense of what is going in this environment. You will find that many course instructors use them to perform even simple tasks like opening a file. To a learner who is following step by step for the first time, such commands may be misconstrued as part of the steps that can only be executed from a shell script.
